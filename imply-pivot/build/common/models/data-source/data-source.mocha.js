...
describe('DataSource', function () {
    ...
    describe("#introspection", function () {
        ...
        it('adds new dimensions', function (testComplete) {
            var columns = {
                "__time": {
                    "type": "LONG",
            ...
            dataSource.introspect()
                .then(function (ds1) {
                chai_1.expect(ds1.toJS().dimensions).to.deep.equal([
                    {
                        "expression": {
                            "name": "__time",
                            "op": "ref"
