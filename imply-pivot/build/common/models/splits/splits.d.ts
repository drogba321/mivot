...
import { RefExpression, TimeRange, SortAction } from 'plywood';
...
export declare class Splits implements Instance<SplitsValue, SplitsJS> {
    ...
    updateWithTimeRange(timeAttribute: RefExpression, timeRange: TimeRange, timezone: Timezone, force?: boolean): Splits;
