...
/***/ function(module, exports, __webpack_require__) {
	...
	var NoDataSourcesApplication = (function (_super) {
	    ...
	    NoDataSourcesApplication.prototype.render = function () {
	        return React.createElement("div", {className: "no-data-sources-application"}, React.createElement("div", {className: "icon"}, React.createElement(svg_icon_1.SvgIcon, {svg: __webpack_require__(478)})), React.createElement("p", null, "There are no data sources configured"));
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./no-data-sources-application.css", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./no-data-sources-application.css");
