...
/******/ 			script.src = __webpack_require__.p + "" + ({"1":"pivot-main","2":"dimension-actions-menu","3":"filter-menu","4":"split-menu","5":"raw-data-modal","6":"clipboard","7":"side-drawer","8":"about-modal","9":"no-data-sources","10":"ios-drag-drop"}[chunkId]||chunkId) + "." + "d596dde16218ec05dc71" + ".js";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var error_monitor_1 = __webpack_require__(170);
	...
	if (config.dataSources.length) {
	    ...
	    __webpack_require__.e/* nsure */(1, function (require) {
	        var List = __webpack_require__(178).List;
	        var WallTime = __webpack_require__(179).WallTime;
	        var queryUrlExecutorFactory = __webpack_require__(183).queryUrlExecutorFactory;
	        var DataSource = __webpack_require__(192).DataSource;
	        var Customization = __webpack_require__(192).Customization;
	        var PivotApplication = __webpack_require__(216).PivotApplication;
	        // Init chronoshift
	        if (!WallTime.rules) {
	            var tzData = __webpack_require__(182);
	            WallTime.init(tzData.rules, tzData.zones);
	        }
	        var dataSources = List(config.dataSources.map(function (dataSourceJS) {
	            var executor = queryUrlExecutorFactory(dataSourceJS.name, '/plywood', version);
	            return DataSource.fromJS(dataSourceJS, { executor: executor });
	        }));
	    ...
	    __webpack_require__.e/* nsure */(9, function (require) {
	        var NoDataSourcesApplication = __webpack_require__(475).NoDataSourcesApplication;
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./pivot-entry.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./pivot-entry.css");
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loader = (function (_super) {
	    ...
	    Loader.prototype.render = function () {
	        return React.createElement("div", {className: "loader"}, React.createElement(svg_icon_1.SvgIcon, {svg: __webpack_require__(177)}));
	    };
	    return Loader;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./svg-icon.css", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./svg-icon.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".svg-icon{pointer-events:none}\n", ""]);
...
/***/ function(module, exports) {
	...
	module.exports = "<svg viewBox=\"0 0 105 105\" xmlns=\"http://www.w3.org/2000/svg\" fill=\"#fff\"><circle cx=\"12.5\" cy=\"12.5\" r=\"12.5\"/><circle cx=\"12.5\" cy=\"52.5\" r=\"12.5\" fill-opacity=\".5\"/><circle cx=\"52.5\" cy=\"12.5\" r=\"12.5\"/><circle cx=\"52.5\" cy=\"52.5\" r=\"12.5\"/><circle cx=\"92.5\" cy=\"12.5\" r=\"12.5\"/><circle cx=\"92.5\" cy=\"52.5\" r=\"12.5\"/><circle cx=\"12.5\" cy=\"92.5\" r=\"12.5\"/><circle cx=\"52.5\" cy=\"92.5\" r=\"12.5\"/><circle cx=\"92.5\" cy=\"92.5\" r=\"12.5\"/></svg>"
