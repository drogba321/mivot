...
describe("floor, move, ceil (UTC)", function () {
    ...
    it("moves seconds", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.second.move(d1, tz, 3)).to.deep.equal(d2); });
    });
    it("rounds minutes", function () {
        chai_1.expect(chronoshift.minute.round(new Date("2012-11-04T00:29:00"), 15, tz))
            .to.deep.equal(new Date("2012-11-04T00:15:00"));
        chai_1.expect(chronoshift.minute.round(new Date("2012-11-04T00:29:00"), 4, tz))
    ...
    it("moves minutes", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.minute.move(d1, tz, 3)).to.deep.equal(d2); });
    });
    it("floors hour correctly", function () {
        chai_1.expect(chronoshift.hour.floor(new Date("2012-11-04T00:30:00"), tz))
            .to.deep.equal(new Date("2012-11-04T00:00:00"));
        chai_1.expect(chronoshift.hour.floor(new Date("2012-11-04T01:30:00"), tz))
            .to.deep.equal(new Date("2012-11-04T01:00:00"));
        chai_1.expect(chronoshift.hour.floor(new Date("2012-11-04T01:30:00"), tz))
            .to.deep.equal(new Date("2012-11-04T01:00:00"));
        chai_1.expect(chronoshift.hour.floor(new Date("2012-11-04T02:30:00"), tz))
            .to.deep.equal(new Date("2012-11-04T02:00:00"));
        chai_1.expect(chronoshift.hour.floor(new Date("2012-11-04T03:30:00"), tz))
    ...
    it("moves hour", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.hour.move(d1, tz, 1)).to.deep.equal(d2); });
    });
    it("moves day", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.day.move(d1, tz, 1)).to.deep.equal(d2); });
    });
    it("ceils day", function () {
        var d1 = new Date("2014-12-11T22:11:57.469Z");
        var d2 = new Date("2014-12-12T00:00:00.000Z");
        chai_1.expect(chronoshift.day.ceil(d1, tz)).to.eql(d2);
    ...
    it("moves week", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.week.move(d1, tz, 1)).to.deep.equal(d2); });
    });
    it("floors week correctly", function () {
        var d1 = new Date("2014-12-11T22:11:57.469Z");
        var d2 = new Date("2014-12-08T00:00:00.000Z");
        chai_1.expect(chronoshift.week.floor(d1, tz)).to.eql(d2);
    ...
    it("ceils week correctly", function () {
        ...
        chai_1.expect(chronoshift.week.ceil(d1, tz)).to.eql(d2);
        d1 = new Date("2014-12-07T12:11:57.469Z");
        d2 = new Date("2014-12-08T00:00:00.000Z");
        chai_1.expect(chronoshift.week.ceil(d1, tz)).to.eql(d2);
    });
    it("moves month", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.month.move(d1, tz, 1)).to.deep.equal(d2); });
    });
    it("moves year", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.year.move(d1, tz, 1)).to.deep.equal(d2); });
    });
});
