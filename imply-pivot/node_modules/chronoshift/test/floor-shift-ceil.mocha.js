...
describe("floor/shift/ceil", function () {
    ...
    it("shifts seconds", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.second.shift(d1, tz, 3)).to.deep.equal(d2); });
    });
    it("shifts minutes", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.minute.shift(d1, tz, 3)).to.deep.equal(d2); });
    });
    it("floors hour correctly", function () {
        chai_1.expect(chronoshift.hour.floor(new Date("2012-11-04T00:30:00-07:00"), tz))
            .to.deep.equal(new Date("2012-11-04T00:00:00-07:00"), 'A');
        chai_1.expect(chronoshift.hour.floor(new Date("2012-11-04T01:30:00-07:00"), tz))
            .to.deep.equal(new Date("2012-11-04T01:00:00-08:00"), 'B');
        chai_1.expect(chronoshift.hour.floor(new Date("2012-11-04T01:30:00-08:00"), tz))
            .to.deep.equal(new Date("2012-11-04T01:00:00-08:00"), 'C');
        chai_1.expect(chronoshift.hour.floor(new Date("2012-11-04T02:30:00-08:00"), tz))
            .to.deep.equal(new Date("2012-11-04T02:00:00-08:00"), 'D');
        chai_1.expect(chronoshift.hour.floor(new Date("2012-11-04T03:30:00-08:00"), tz))
    ...
    it("shifts hour over DST", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.hour.shift(d1, tz, 1)).to.deep.equal(d2); });
    });
    it("shifts day over DST", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.day.shift(d1, tz, 1)).to.deep.equal(d2); });
    });
    it("shifts week over DST", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.week.shift(d1, tz, 1)).to.deep.equal(d2); });
    });
    ...
    it("shifts month over DST", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.month.shift(d1, tz, 1)).to.deep.equal(d2); });
    });
    it("shifts year", function () {
        ...
        pairwise(dates, function (d1, d2) { return chai_1.expect(chronoshift.year.shift(d1, tz, 1)).to.deep.equal(d2); });
    });
});
