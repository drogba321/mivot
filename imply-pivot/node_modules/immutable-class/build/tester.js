...
function testImmutableClass(ClassFn, objects, options) {
    ...
    chai_1.expect(ClassFn['is' + className], className + ".is" + className + " should exist").to.be.a('function');
    ...
    var isClass = ClassFn['is' + className];
    chai_1.expect(isClass(null), "is" + className + " should fail on null").to.equal(false);
    chai_1.expect(isClass([]), "is" + className + " should fail on []").to.equal(false);
    chai_1.expect(isClass(''), "is" + className + " should fail on ''").to.equal(false);
    for (var i = 0; i < objects.length; i++) {
        ...
        chai_1.expect(isClass(inst), "is" + className + ".is" + className + " failed on something created with toJS" + where).to.equal(true);
