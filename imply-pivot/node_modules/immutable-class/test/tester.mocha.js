...
var tester_1 = require('../build/tester');
var Animal = (function () {
    ...
    Animal.isAnimal = function (animal) {
        return index_1.isInstanceOf(animal, Animal);
    };
...
var AnimalNoFromJS = (function () {
    ...
    AnimalNoFromJS.isAnimalNoFromJS = function (animal) {
        return index_1.isInstanceOf(animal, AnimalNoFromJS);
    };
...
var AnimalBadToJS = (function () {
    ...
    AnimalBadToJS.isAnimalBadToJS = function (animal) {
        return index_1.isInstanceOf(animal, AnimalBadToJS);
    };
...
var AnimalWithContext = (function () {
    ...
    AnimalWithContext.isAnimalWithContext = function (animal) {
        return index_1.isInstanceOf(animal, AnimalWithContext);
    };
...
describe("testImmutableClass", function () {
    it("works for Animal class", function () {
        tester_1.testImmutableClass(Animal, [
            "Koala",
            "Snake",
            "Dog",
            "Cat"
    ...
    it("rejects AnimalNoFromJS class", function () {
        expect(function () {
            tester_1.testImmutableClass(AnimalNoFromJS, [
                "Koala",
                "Snake",
                "Dog"
            ]);
    ...
    it("rejects AnimalBadToJS class", function () {
        expect(function () {
            tester_1.testImmutableClass(AnimalBadToJS, [
                "Koala",
                "Snake",
                "Dog"
            ]);
    ...
    it("works for AnimalWithContext class (with context)", function () {
        ...
        tester_1.testImmutableClass(AnimalWithContext, [
            "Koala",
            "Snake",
            "Dog"
        ], {
